...
print qq^
    ...
    <tr><td bgcolor="$colors{'functitle'}" align=center><font face="system" color="$colors{'functitletext'}"><img src="/megaboard/images/ban.gif">Ban User!</font></td></tr>
    ...
    <INPUT TYPE="hidden" NAME="job" VALUE="banuser">
...
else
{
  print "Password (case-sensitive):";
	...
	else # BAN THE FRICKEN USER!
	{
	   $ip = @lines[6];

	   open(BANNED, ">$datapath/banned.dat");
	   print BANNED "$ip\n";
	   close(BANNED);
